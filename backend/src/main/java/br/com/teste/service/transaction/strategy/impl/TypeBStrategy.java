...
@Component
public class TypeBStrategy implements TransactionTypeStrategy {

    @Override
    public Tax execute(SchedulingRequest schedulingRequest) {
        final BigDecimal tax = BigDecimal.valueOf(12.00);
...
//                .build();
    ...
    public String transactionType() {
        return TransactionType.TRANSACTION_B.getTransactionType();
    }
